...
import Postulations from './components/Postulations.vue'
...
const routes = [
    ...
    { path: '/claimsPa', component: Claimspanel },
    { path: '/postulations', component: Postulations },
    { path: '/newpanel', component: NewPanel}
];
...
Vue.component('cv', Cv);
Vue.component('claimsPa', Claimspanel);
Vue.component('postulations', Postulations);
Vue.component('newpanel', NewPanel);
